...
public class ShipRenderer extends BaseRenderer
{
	...
	public void render(SpriteBatch batch, OrthographicCamera cam)
	{
		...
		this.font.setScale(SCALE, SCALE);
		...
		float debug_x = this.ship.getPosition().x + 40 + this.ship.getBounds().width * SCALE;
		float debug_y = this.ship.getPosition().y + 40 + this.ship.getBounds().height * SCALE;
